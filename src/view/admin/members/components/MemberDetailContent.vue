...
watch(() => props.id, id => {
  ...
  formData.value = found
    ? {
        ...
        email: found.email,
        phone: found.phone,
        identityType: found.identityType || 'general',
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-control">
            ...
            <select v-model="formData.identityType" class="select select-bordered w-full">
              ...
              <option value="government">政府機關 / 公部門</option>
              <option value="school">學校單位 / 學生組織</option>
              <option value="company">企業法人 / 公司行號</option>
              <option value="npo">非營利組織 / 人民團體</option>
            </select>
          </div>

          <div class="form-control col-span-full" v-if="formData.identityType !== 'general'">
