...
import OpeningHoursEditor from '@/components/venue/OpeningHoursEditor.vue';
    ...
    <div class="card bg-base-100 shadow-sm">
      <div class="card-body">
        <label class="label cursor-pointer justify-start gap-4 p-0">
          <input v-model="formData.isActive" type="checkbox" class="toggle toggle-success toggle-lg" />
          <div>
            <span class="font-bold">啟用此場館</span>
            <p class="text-base-content/50 mt-1">停用後，此場館將完全不會顯示在前台，但後台設定會保留</p>
          </div>
        </label>
      </div>
    </div>
