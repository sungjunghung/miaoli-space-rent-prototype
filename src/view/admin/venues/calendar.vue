...
import CalendarHeader from '@/components/adminCalendar/CalendarHeader.vue';
import DayView from '@/components/adminCalendar/DayView.vue';
import WeekView from '@/components/adminCalendar/WeekView.vue';
import MonthView from '@/components/adminCalendar/MonthView.vue';
import YearView from '@/components/adminCalendar/YearView.vue';
import BookingTooltip from '@/components/adminCalendar/BookingTooltip.vue';
import EventModal from '@/components/adminCalendar/EventModal.vue';
...
<template>
  ...
  <CalendarHeader @add-note="handleCreateEvent(calendar.anchorDate.value ?? new Date())"
    @add-blocked="handleCreateBlocked(calendar.anchorDate.value ?? new Date())" />
